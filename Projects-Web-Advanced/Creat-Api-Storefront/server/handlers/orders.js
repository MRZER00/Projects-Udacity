    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                res.status(400)
                    .json("Some Required Parameters Are Missing!? Check This >> EX: (products, status, user_id): ".concat(error_1));
                return [3 /*break*/, 4];
...
function orderRoutes(app) {
    ...
    app.post("/create_orders", Auth_1.default, create);
    app.get("/current_order/:id", Auth_1.default, show);
}
